...
gui.add(material.uniforms.offset, 'value').min(0.1).max(100.0).step(0.01).name('offset');
gui.add(material.uniforms.darkness, 'value').min(0.1).max(100.0).step(0.01).name('darkness');
